...
const getTopThreeTrendingServices = async () => {
  const result = await Tour.find({}).sort('-viewCount createdAt bookedVacancy')
  return result
  
};

module.exports = { postTourService, getOneTourService, updateOneTourService , getTopThreeTrendingServices };
